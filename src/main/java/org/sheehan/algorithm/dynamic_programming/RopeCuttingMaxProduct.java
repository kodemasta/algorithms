...
public class RopeCuttingMaxProduct {
    ...
    public static int recursive(int totalLength){
        ...
        for (int currLength = 1; currLength < totalLength; ++currLength){
            ...
            int currMaxProduct = Math.max(currProduct, currLength * recursive(remainingLength));
    ...
    // O(n^2)
    public static int dp(int totalLength) {
